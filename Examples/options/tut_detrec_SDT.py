...
gun.EnergyMaxs = [2]  # GeV
gun.ThetaMins  = [40]   # deg
gun.ThetaMaxs  = [140]  # deg
gun.PhiMins    = [0]  # deg
gun.PhiMaxs    = [360]  # deg
#stdheprdr = StdHepRdr("StdHepRdr")
#stdheprdr.Input = "/cefs/data/stdhep/CEPC240/higgs/update_from_LiangHao_1M/data/E240.Pn2n2h_e2e2.e0.p0.whizard195/n2n2h_e2e2.e0.p0.0010.stdhep"
...
digiDC.mixNoise = False
digiDC.noiseEff = 0
digiDC.mixNoiseAndSkipOverlapthis = False
digiDC.mixNoiseAndSkipNoOverlapthis = False
digiDC.smear = True
...
#truthTrackerAlg.maxDigiCut=600
truthTrackerAlg.useSi=True
truthTrackerAlg.hist=True
truthTrackerAlg.useTruthTrack=False
truthTrackerAlg.resVertexX=0
truthTrackerAlg.resVertexY=0
truthTrackerAlg.resVertexZ=0
truthTrackerAlg.DCTrackFinding=True
truthTrackerAlg.DigiDCHitCollection= dchitname
truthTrackerAlg.VXDTrackerHitAssociation= "VXDTrackerHitAssociation"
...
recGenfitAlgSDT.DCTrackFinding= True
recGenfitAlgSDT.iterFit= 2
recGenfitAlgSDT.useSalHits = True
recGenfitAlgSDT.addSET = True
#recGenfitAlgSDT.noMaterialEffects= True
recGenfitAlgSDT.skipNear = 0. #cm
...
ntsvc.Output = [
        "MyTuples DATAFILE='DCH_digi.root' OPT='NEW' TYP='ROOT'",
        "TruthTrackerAlg DATAFILE='truthTracker.root' OPT='NEW' TYP='ROOT'",
        "DCTrackFinding DATAFILE='Track_Finding.root' OPT='NEW' TYP='ROOT'",
        "RecGenfitAlgSDT DATAFILE='fit_Track.root' OPT='NEW' TYP='ROOT'"
]

from Configurables import DCTrackFinding
dcTrackFinding = DCTrackFinding("DCTrackFinding")
dcTrackFinding.DigiDCHitCollection = dchitname
dcTrackFinding.pathSelectFilterName = "distance"
#dcTrackFinding.noMaterialEffects= True
#dcTrackFinding.correctBremsstrahlung= False
#dcTrackFinding.pathSelectFilterName = "chi2"
#dcTrackFinding.pathSelectFilterName = "arc_length"


# output
from Configurables import PodioOutput
out = PodioOutput("outputalg")
out.filename = "CRD_detrec.root"
out.outputCommands = ["keep *"]

# ApplicationMgr
from Configurables import ApplicationMgr
ApplicationMgr(
    TopAlg = [genalg, detsimalg, digiVXD, digiSIT, digiSET, digiFTD, spFTD,
        digiDC, tracking, forward, subset,truthTrackerAlg, dcTrackFinding,
        recGenfitAlgSDT,out],
    EvtSel = 'NONE',
    EvtMax = 1,

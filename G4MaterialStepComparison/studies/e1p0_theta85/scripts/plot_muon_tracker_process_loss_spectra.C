...
void plot_muon_tracker_process_loss_spectra(const char* outdir = "G4MaterialStepComparison/studies/e1p0_theta85") {
  ...
  for (int i = 1; i <= 10; ++i) ch.Add(Form("gsf_material_steps-mu--1.0-85-%d.root", i));
  ...
  out << "Muon files: gsf_material_steps-mu--1.0-85-{1..10}.root. Primary muon: track_id==1 && parent_id==0 && pdg==13.\n";

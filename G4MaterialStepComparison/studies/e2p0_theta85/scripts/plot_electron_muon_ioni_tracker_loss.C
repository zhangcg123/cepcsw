...
void plot_electron_muon_ioni_tracker_loss(const char* outdir = "G4MaterialStepComparison/studies/e2p0_theta85") {
  ...
  fillSample("gsf_material_steps-e--2.0-85-%d.root", 11, hE, eLoss);
  fillSample("gsf_material_steps-mu--2.0-85-%d.root", 13, hMu, muLoss);
  ...
  out << "electron: gsf_material_steps-e--2.0-85-{1..10}.root, pdg==11, process_subtype==2 (eIoni).\n";
  out << "muon: gsf_material_steps-mu--2.0-85-{1..10}.root, pdg==13, process_subtype==2 (muIoni).\n\n";

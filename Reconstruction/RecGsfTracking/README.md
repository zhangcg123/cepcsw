...
local innovation likelihood, the corresponding all-hit state, and normalized
scores with and without the existing backward prior. These quantities never
replace live component weights or states. A

...
`i+1 -> i`; targets beyond the innermost measurement clamp to hit 0 and are
deduplicated. Each hit's posterior is normalized separately, the posteriors
are arithmetically averaged, and the temporary states are discarded. The live

...
dsvc = k4DataSvc("EventDataSvc", input="trk-e--1.0-85-2.root")
...
flat.OutputFile = "gsf_flat-e--1.0-85-2.root"
flat.BField = 3.0
flat.HitCollectionNames = ["VXDTrackerHits", "ITKBarrelTrackerHits", "TPCTrackerHits", "OTKBarrelTrackerHits"]

from Configurables import PodioOutput
out = PodioOutput("outputalg"); out.filename = "gsf-e--1.0-85-2.root"; out.outputCommands = ["keep *"]

...
dsvc = k4DataSvc("EventDataSvc", input="trk-e--0.5-85-1.root")
...
flat.OutputFile = "gsf_flat-e--0.5-85-1.root"
flat.BField = 3.0
flat.HitCollectionNames = ["VXDTrackerHits", "ITKBarrelTrackerHits", "TPCTrackerHits", "OTKBarrelTrackerHits"]

from Configurables import PodioOutput
out = PodioOutput("outputalg"); out.filename = "gsf-e--0.5-85-1.root"; out.outputCommands = ["keep *"]
